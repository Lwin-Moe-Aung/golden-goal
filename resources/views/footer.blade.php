...
<div class="footer">
    <div class="container px-4 sm:px-8">
        <h4  style="font-size:18px;" class="mb-8 lg:max-w-3xl lg:mx-auto">Golden Goal is a mobile application for football fans and you can reach the team at <a class="text-indigo-600 hover:text-gray-500" href="mailto:goldengoal.ggwp@gmail.com">goldengoal.ggwp@gmail.com</a></h4>
